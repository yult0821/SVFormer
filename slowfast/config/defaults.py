...
_C.MODEL.SINGLE_PATHWAY_ARCH = ["2d", "c2d", "i3d", "slow", "x3d", "mvit", "uniformer", "spikingformer", "spikingformer_cml", "sew_resnet", "uniformer_snn", "uniformer_psnn", "uniformer2d_snn", "uniformer2d_psnn", "uniformer2d_psnn_act", "uniformer2d_psnn_norm", "uniformer2d_psnn_bn", "uniformer2d_psnn_try", "uniformer2d_psnn_tri", "uniformer2d_prsnn", "rsew_resnet", "uniformer2d_psnn_convBnLif", "uniformer2d_psnn_head", "uniformer2d_psnn_lgf", "uniformer2d_psnn_qkf", "uniformer2d_psnn_convqkf", "uniformer2d_if_lgf", "uniformer2d_psnn_lgfT", "qkformer", "uniformer3d_psnn", "uniformer3d_psnn_lgf", "sglformer", "metaspikformer"]
...
# time steps for uniformer_snn
_C.UNIFORMER.T = 1


# -----------------------------------------------------------------------------
# Spikingformer options
# -----------------------------------------------------------------------------
_C.SPIKINGFORMER = CfgNode()

_C.SPIKINGFORMER.DEPTH = 8

_C.SPIKINGFORMER.PATCH_SIZE = 16

_C.SPIKINGFORMER.EMBED_DIM = 384

_C.SPIKINGFORMER.NUM_HEADS = 8

_C.SPIKINGFORMER.MLP_RATIO = 4

_C.SPIKINGFORMER.QKV_BIAS = False

_C.SPIKINGFORMER.QKV_SCALE = None

_C.SPIKINGFORMER.DROPOUT_RATE = 0

_C.SPIKINGFORMER.ATTENTION_DROPOUT_RATE = 0

_C.SPIKINGFORMER.DROP_DEPTH_RATE = 0.2

_C.SPIKINGFORMER.SR_RATIOS = 1

_C.SPIKINGFORMER.PRETRAIN_NAME = None


# -----------------------------------------------------------------------------
# Spikingformer_cml options
# -----------------------------------------------------------------------------
_C.SPIKINGFORMER_CML = CfgNode()

_C.SPIKINGFORMER_CML.DEPTH = 8

_C.SPIKINGFORMER_CML.PATCH_SIZE = 16

_C.SPIKINGFORMER_CML.EMBED_DIM = 384

_C.SPIKINGFORMER_CML.NUM_HEADS = 8

_C.SPIKINGFORMER_CML.MLP_RATIO = 4

_C.SPIKINGFORMER_CML.QKV_BIAS = False

_C.SPIKINGFORMER_CML.QKV_SCALE = None

_C.SPIKINGFORMER_CML.DROPOUT_RATE = 0

_C.SPIKINGFORMER_CML.ATTENTION_DROPOUT_RATE = 0

_C.SPIKINGFORMER_CML.DROP_DEPTH_RATE = 0.2

_C.SPIKINGFORMER_CML.SR_RATIOS = 1

_C.SPIKINGFORMER_CML.PRETRAIN_NAME = None
...
_C.QKFORMER.PATCH_SIZE = 16

_C.QKFORMER.EMBED_DIM = 384

_C.QKFORMER.NUM_HEADS = 8

_C.QKFORMER.MLP_RATIO = 4

_C.QKFORMER.QKV_BIAS = False

_C.QKFORMER.QKV_SCALE = None

_C.QKFORMER.DROPOUT_RATE = 0

_C.QKFORMER.ATTENTION_DROPOUT_RATE = 0

_C.QKFORMER.DROP_DEPTH_RATE = 0.2

_C.QKFORMER.SR_RATIOS = 1

_C.QKFORMER.PRETRAIN_NAME = None


# -----------------------------------------------------------------------------
# metaspikformer options
# -----------------------------------------------------------------------------
_C.METASPIKFORMER = CfgNode()

_C.METASPIKFORMER.DEPTH = 8

_C.METASPIKFORMER.PATCH_SIZE = 16

_C.METASPIKFORMER.EMBED_DIM = [96, 192, 384, 480]

_C.METASPIKFORMER.NUM_HEADS = 8

_C.METASPIKFORMER.MLP_RATIO = 4

_C.METASPIKFORMER.QKV_BIAS = False

_C.METASPIKFORMER.QKV_SCALE = None

_C.METASPIKFORMER.DROPOUT_RATE = 0

_C.METASPIKFORMER.ATTENTION_DROPOUT_RATE = 0

_C.METASPIKFORMER.DROP_DEPTH_RATE = 0.2

_C.METASPIKFORMER.SR_RATIOS = 1

_C.METASPIKFORMER.KD = False

_C.METASPIKFORMER.PRETRAIN_NAME = None


# -----------------------------------------------------------------------------
# SEWResNet options
# -----------------------------------------------------------------------------
_C.SEWRESNET = CfgNode()

_C.SEWRESNET.LAYERS = [3, 4, 23, 3]  # [3, 4, 23, 3] for sew_resnet101

_C.SEWRESNET.CNF = "ADD"

_C.SEWRESNET.PRETRAIN_NAME = 'sew_resnet101_in1k'
