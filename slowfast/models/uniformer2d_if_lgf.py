...
#     return neuron.KLIFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='torch') #surrogate.Sigmoid()
    ...
    return neuron.LIFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='cupy') # backend='cupy' 'torch' # 2024.2.22
...
class Uniformer2d_if_lgf(nn.Module): # uniformer2d_psnn_try28_allBNT_headV2.py
    """ Vision Transformer
