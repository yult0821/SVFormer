...
# set step_mode=m for non-recurrent module?? (default is s)
def set_step_mode(net, step_mode='m', keep_instance=None):
    ...
    # print("keep_step_mode_containers:", keep_step_mode_containers)
...
# set backend=cupy for non-recurrent module?? (default is torch)
def set_backend(net, backend='cupy', instance=neuron.BaseNode, keep_instance=None):
    ...
    # print("keep_backend_containers:", keep_backend_containers)
