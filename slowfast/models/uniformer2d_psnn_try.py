...
#     return neuron.KLIFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='torch') #surrogate.Sigmoid()
    ...
    return neuron.ParametricLIFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='cupy') 
    #return neuron.ParametricLIFNode(v_threshold=0.5, surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='cupy') # backend='cupy' 'torch'
...
class Uniformer2d_psnn_try(nn.Module): # uniformer2d_psnn_try28_allBNT_headV2.py
    """ Vision Transformer
