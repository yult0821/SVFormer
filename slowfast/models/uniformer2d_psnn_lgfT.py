...
#     return neuron.KLIFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='torch') #surrogate.Sigmoid()
    ...
    return neuron.ParametricLIFNode(v_threshold=2.0, surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='cupy')
...
class Uniformer2d_psnn_lgfT(nn.Module): # uniformer2d_psnn_try28_allBNT_headV2.py
    """ Vision Transformer
