...
#     return neuron.KLIFNode(surrogate_function=surrogate.ATan(), detach_reset=True, step_mode='m', backend='torch') #surrogate.Sigmoid()
    ...
    return neuron.ParametricLIFNode(surrogate_function=surrogate.Sigmoid(), detach_reset=True, step_mode='m', backend='cupy') 
...
class Uniformer2d_psnn_tri(nn.Module): # uniformer2d_psnn_try28_allBNT_headV2.py
    """ Vision Transformer
