                ...
                "clip count {} ~= num clips {}".format(
                    ", ".join(
                        [
                            ...
                            if k != self.num_clips  # add this line to only output unmatched samples (added by yult 0519)
                        ]
                    ),
                    self.num_clips,
                )
...
class TrainMeter(object):
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        if not self._cfg.DATA.MULTI_LABEL:
            ...
            stats["loss"] = avg_loss
        logging.log_json_stats(stats)
        # return epoch states for tensorboard writter
        return avg_loss, self.lr, top1_err, top5_err
...
class ValMeter(object):
    ...
    def log_epoch_stats(self, cur_epoch):
        ...
        logging.log_json_stats(stats)
        # return epoch states for tensorboard writter and saving best ckpt
