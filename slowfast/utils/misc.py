...
def log_model_info(model, cfg, use_train_input=True):
    ...
    try:
        ...
        logger.info("Error occurred when executing get_model_stats in misc.py, Flops cannot be calculated.")
    try:
        logger.info(
        ...
        logger.info("Error occurred when executing get_model_stats in misc.py, Activations cannot be calculated.")
