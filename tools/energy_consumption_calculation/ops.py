...
try:
    ...
    from spikingjelly.activation_based.neuron import IFNode, LIFNode, ParametricLIFNode
...
def spike_rate(inp):
    ...
    #Nspks_max = 40 #30  # for spikformer-4-384, real Nspks_max is 9 (2*4+1=9)；for spikformer-8-512, real Nspks_max is 17 (2*8+1=17)；
